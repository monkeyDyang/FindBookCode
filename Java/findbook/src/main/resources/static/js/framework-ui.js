...
$.currentWindow = function () {
    var iframeId = top.$(".Sundy_iframe:visible").attr("id");
...
$.SndConfirmForm = function (options) {
    var defaults = {
        prompt: "注：您确定要进行该操作吗？",
        url: "",
        param: [],
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".Sundy_iframe:visible").attr("id").substr(6);
