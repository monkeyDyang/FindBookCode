    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
            ...
            endReq = function () {
                ...
                if (ts.p.unwritten) {
                    $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').eq(0).find(".unwritten").remove();
                    if ($("#" + ts.p.id).find('tbody tr').length == 1) {
                        $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').eq(0).append('<div class="unwritten" style="color:red;padding:7px;border-bottom:#ddd 1px solid;">没有找到您要的相关数据!</div>')
                    }
                }
            },
    ...
    $.fn.treeview = function (settings) {
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (dfop.showcheck && nd.showcheck) {
                ...
                ht.push("<img  id='", id, "_", nid, "_cb' class='bbit-tree-node-cb' src='", dfop.cbiconpath, dfop.icons[nd.checkstate], "' style='margin-top:4px;' />");
            }
